...
- macOS Apple Silicon: [`Skiller-Desktop-arm64.dmg`](https://github.com/gannonh/skiller/releases/download/desktop-v0.3.0/Skiller-Desktop-arm64.dmg)
- macOS Intel: [`Skiller-Desktop-x64.dmg`](https://github.com/gannonh/skiller/releases/download/desktop-v0.3.0/Skiller-Desktop-x64.dmg)
- Linux x64: [`Skiller-Desktop-x86_64.AppImage`](https://github.com/gannonh/skiller/releases/download/desktop-v0.3.0/Skiller-Desktop-x86_64.AppImage) or [`Skiller-Desktop-amd64.deb`](https://github.com/gannonh/skiller/releases/download/desktop-v0.3.0/Skiller-Desktop-amd64.deb)
- Linux arm64: [`Skiller-Desktop-arm64.AppImage`](https://github.com/gannonh/skiller/releases/download/desktop-v0.3.0/Skiller-Desktop-arm64.AppImage) or [`Skiller-Desktop-arm64.deb`](https://github.com/gannonh/skiller/releases/download/desktop-v0.3.0/Skiller-Desktop-arm64.deb)

The latest desktop release is `desktop-v0.3.0`.

## Usage

Use the Library view to install skills from a local folder, GitHub URL or shorthand such as `gannonh/skiller`, or the skills.sh registry. When you enter a repository URL or shorthand, Skiller scans it for installable skills and lets you select the ones you want. If an install matches an existing skill name, Skiller asks before replacing it. Organize skills with sets and tags, then sort or filter the library around those labels. Use Targets to choose agent skill directories, then sync enabled skills into those targets. Use Updates to check GitHub and skills.sh installs for newer upstream commits and apply updates. When a packaged app update finishes downloading, use the Update button beside the Skiller heading to restart into the new version.
